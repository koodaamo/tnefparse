...
class TNEFMAPI_Attribute(object):
    ...
    PID_TAG_CREATOR_ENTRY_ID = 0x3FF9
    PID_TAG_LAST_MODIFIER_ENTRY_ID = 0x3FFB
    PID_TAG_MESSAGE_CODEPAGE = 0x3FFD

    PID_TAG_INTERNET_MAIL_OVERRIDE_FORMAT = 0x5902
    PID_TAG_MESSAGE_EDITOR_FORMAT = 0x5909
    PID_TAG_SENDER_SMTP_ADDRESS = 0x5D01
    PID_TAG_SENT_REPRESENTING_SMTP_ADDRESS = 0x5D02
    PID_TAG_READ_RECEIPT_SMTP_ADDRESS = 0x5D05
    PID_TAG_RECEIVED_BY_SMTP_ADDRESS = 0x5D07
    PID_TAG_RECEIVED_REPRESENTING_SMTP_ADDRESS = 0x5D08
    PID_TAG_SIP_ADDRESS = 0x5FE5

    PID_TAG_ATTACHMENT_LINK_ID = 0x7FFA
    PID_TAG_EXCEPTION_START_TIME = 0x7FFB
    PID_TAG_EXCEPTION_END_TIME = 0x7FFC
    PID_TAG_ATTACHMENT_FLAGS = 0x7FFD
    PID_TAG_ATTACHMENT_HIDDEN = 0x7FFE
    PID_TAG_ATTACHMENT_CONTACT_PHOTO = 0x7FFF
    ...
    codes = {
        ...
        PID_TAG_CREATOR_ENTRY_ID: "PID_TAG_CREATOR_ENTRY_ID",
        PID_TAG_LAST_MODIFIER_ENTRY_ID: "PID_TAG_LAST_MODIFIER_ENTRY_ID",
        PID_TAG_MESSAGE_CODEPAGE: "PID_TAG_MESSAGE_CODEPAGE",
        PID_TAG_INTERNET_MAIL_OVERRIDE_FORMAT: "PID_TAG_INTERNET_MAIL_OVERRIDE_FORMAT",
        PID_TAG_MESSAGE_EDITOR_FORMAT: "PID_TAG_MESSAGE_EDITOR_FORMAT",
        PID_TAG_SENDER_SMTP_ADDRESS: "PID_TAG_SENDER_SMTP_ADDRESS",
        PID_TAG_SENT_REPRESENTING_SMTP_ADDRESS: "PID_TAG_SENT_REPRESENTING_SMTP_ADDRESS",
        PID_TAG_READ_RECEIPT_SMTP_ADDRESS: "PID_TAG_READ_RECEIPT_SMTP_ADDRESS",
        PID_TAG_RECEIVED_BY_SMTP_ADDRESS: "PID_TAG_RECEIVED_BY_SMTP_ADDRESS",
        PID_TAG_RECEIVED_REPRESENTING_SMTP_ADDRESS: "PID_TAG_RECEIVED_REPRESENTING_SMTP_ADDRESS",
        PID_TAG_SIP_ADDRESS: "PID_TAG_SIP_ADDRESS",
        PID_TAG_ATTACHMENT_LINK_ID: "PID_TAG_ATTACHMENT_LINK_ID",
        PID_TAG_EXCEPTION_START_TIME: "PID_TAG_EXCEPTION_START_TIME",
        PID_TAG_EXCEPTION_END_TIME: "PID_TAG_EXCEPTION_END_TIME",
        PID_TAG_ATTACHMENT_FLAGS: "PID_TAG_ATTACHMENT_FLAGS",
        PID_TAG_ATTACHMENT_HIDDEN: "PID_TAG_ATTACHMENT_HIDDEN",
        PID_TAG_ATTACHMENT_CONTACT_PHOTO: "PID_TAG_ATTACHMENT_CONTACT_PHOTO",
