...
argument('-o','--overview', action='store_true', help='show long debug overview of TNEF file contents')
argument('-a','--attachments', action='store_true', help='extract attachments to current directory')
...
argument('-l', '--logging', help="enable logging by setting a log level", choices = ["DEBUG", "INFO", "WARN", "ERROR"])
argument('-c', '--checksum', help="calculate checksums (off by default)", action="store_true", default=False)
